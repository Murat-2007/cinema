...
from account.forms import LoginForm, CreateUserForm, ProfileForm, UserForm, UserPasswordChangeForm
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                form.add_error(None, "email veya parola hatali")
...
def register_request(request):
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            form.add_error(None, "Fill in the form completely")
